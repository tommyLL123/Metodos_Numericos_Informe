...
\begin{abstract}
%% Text of abstract
El proyecto estudiará un flujo continuo descrito por una EDO que transporta muestras desde una distribución inicial simple hacia una distribución objetivo bidimensional. En lugar de entrenar un modelo generativo de imágenes a gran escala, el grupo implementará campos vectoriales de prueba o entrenará una red pequeña sobre datos sintéticos y evaluará cómo el integrador altera la trayectoria, el error final y el costo. Los cinco papers son variantes de rectified flow, flow matching y trayectorias de transporte más rectas.
\end{abstract}
